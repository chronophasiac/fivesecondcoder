...
card.answers.create(start_offset: 6, end_offset: 6)
card.answers.create(start_offset: 36, end_offset: 36)
...
card.answers.create(start_offset: 119, end_offset: 119)
...
card.answers.create(start_offset:295, end_offset: 298)
